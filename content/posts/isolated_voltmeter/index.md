...
Aside from the wider sense range, there's another benefit to the 3-wire version: you can power it from a constant voltage and thus avoid the display brightness changing as you adjust voltage.

I chose the 3-wire variant, and the ones I got have two markings on the circuit board, `V1303` and `DVM036A`. Unfortunately, searching for either of those terms doesn't work too well. I had best luck searching `calibratable mini digital voltmeter`. I paid about $10 for 5 of them; since I had everything else needed, the project cost only includes the two meters.
...
The meter wires forming the larger loop (exiting the frame) are for the positive meter, while the smaller loop is negative. For the meters, white is sense.
...
#### adjusting the model
If you actually print this, you may wish to increase the clearance around the meters - I remember needing to do a fair amount of sanding before they would fit.

While you're making adjustments, find a pair of screws long enough and adjust the screw holes to work. You want a clearance fit outside, while on the inside you want holes small enough for the threads to bite but not so small that the print breaks. 
